  ...
  ?>
   ...
   <br><br>
    ...
    <?php
        ...
        echo "<tr>";
        echo "<td width='600' align='center'><img src='../img/manga/".$data["comic_pic"].".jpg' width='450' height='600'></td>";
        echo "<td width='400'>";
        ...
        echo "<br><br><br><br><br><a href='purchase.php'><button class='button'>Buy</button></a><br><br><br><br><br><br>";
        echo "</td>";
        echo "</tr>";
        echo "</table>";
